...
原作者：RuoChennn  
原项目地址：[https://github.com/RuoChennn/MapSyncer-for-XaeroWorldmap](https://github.com/RuoChennn/MapSyncer-for-XaeroWorldmap)

当前 Fabric `26.1.2` 版本由 ShanHe_YF 制作。
...
`mapsyncer-1.0.1-fabric-sources.jar` 是源码包，不是放入 Minecraft `mods` 目录的文件。清理构建产物后需要重新执行构建命令才会生成这些文件。
